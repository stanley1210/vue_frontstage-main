<template>
  ...
  .card-wrapper {
	...
	min-height: 120vh; /* 确保容器占满整个视口高度 */
	background-color: #f5f5f5; 
  }
  
  .card {
	max-width: 1300px; /* 增大卡片的最大宽度 */
	width: 100%; /* 卡片宽度占满容器宽度 */
	padding: 20px;
