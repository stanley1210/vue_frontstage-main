    ...
    <div class="homebackground">
        ...
        >
          ...
          <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="4000">
              <img
                src="/public/img/homepageIMG01.jpg"
                class="d-block w-100"
                alt="..."
              />
            </div>
            <div class="carousel-item" data-bs-interval="4000">
              <img
                src="/public/img/homepageIMG03.jpg"
                class="d-block w-100"
                alt="..."
              />
            </div>
            <div class="carousel-item" data-bs-interval="000">
              <img
                src="/public/img/homepageIMG02.jpg"
                class="d-block w-100"
                alt="..."
              />
            </div>
      ...
      <div class="homepageManu">
        <div class="homepageBTMBox">
          <RouterLink class="homepageBTM" :to="{ name: 'home-link' }"
            >GL HEllo</RouterLink
          >
        </div>
        <div class="homepageBTMBox">
          <RouterLink class="homepageBTM" :to="{ name: 'about' }"
            >About</RouterLink
          >
        </div>
        <!--  href="/pages/about" -->
        <div class="homepageBTMBox">
          <RouterLink class="homepageBTM" :to="{ name: 'pages-shop-home-link' }"
            >Shop</RouterLink
          >
        </div>
        <div class="homepageBTMBox">
          <a href="" class="homepageBTM">Estimate</a>
        </div>
        <div class="homepageBTMBox">
          <a href="" class="homepageBTM">News</a>
        </div>
