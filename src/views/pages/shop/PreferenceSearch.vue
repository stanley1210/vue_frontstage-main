<template>
  <section>
    ...
    <div v-if="paginatedResults.length > 0" class="card-container">
      ...
      >
        ...
        <div class="card-body navbarBody" style="border: unset">
          ...
          <el-button type="primary" color="#a33238" @click="cardetail(data)"
            >車輛詳細資訊</el-button
          >
        </div>
      </div>
    ...
    <div class="pagination-container">
      ...
      <div>每頁顯示 {{ pageSize }} 筆</div>
    </div>
    <br />
    <el-button @click="goBack" type="default" color="#a33238"
      >返回查詢</el-button
    >
  </section>
</template>
