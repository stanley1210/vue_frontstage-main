<template>
    <div class="card" style="width: 26rem;">
        <font-awesome-icon :icon="['fas', 'star-of-life']" :spin="isSpinning" :style="{ color: iconColor }" size="lg"
            @mouseover="handleMouseOver" @mouseleave="handleMouseLeave" class="likeLogo" @click="handleLikeCreate" />
        ...
        <div @click="navigateToCar">
            ...
            <div class="card-body navbarBody" style="border: unset;">
                ...
                <div class="d-flex flex-row">
                    <div class="card-text " style="padding-left: 0;padding-right: 0;">{{ shopHomeCard.milage }} KM
                        &nbsp;&nbsp;/ &nbsp;&nbsp;{{ shopHomeCard.productionYear }}</div>
                    <div class="card-text" style="padding-left: 0;padding-right: 0;position: absolute;right:5%;">{{
                        shopHomeCard.price }} NTD</div>
                </div>
